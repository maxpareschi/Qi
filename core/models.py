...
# Get a sample config for validation settings
_dev_mode = os.getenv("QI_DEV_MODE", "false").lower() == "true"
...
class QiBaseModel(BaseModel):
    ...
    model_config = ConfigDict(
        ...
        validate_assignment=_dev_mode,
        validate_default=_dev_mode,
        validate_return=_dev_mode,
        validate_on_construction=_dev_mode,
        extra="forbid" if _dev_mode else "allow",
    )
