...
class QiBaseModel(BaseModel):
    ...
    model_config = ConfigDict(
        ...
        validate_assignment=app_config.dev_mode,
        validate_default=app_config.dev_mode,
        validate_return=app_config.dev_mode,
        validate_on_construction=app_config.dev_mode,
        extra="forbid" if app_config.dev_mode else "allow",
    )
